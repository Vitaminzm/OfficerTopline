...
public class FragmentTabUtils implements RadioGroup.OnCheckedChangeListener {
     ...
     * @param rgs
     */
    public FragmentTabUtils(FragmentManager fragmentManager, List<Fragment> fragments, int fragmentContentId, RadioGroup rgs, OnRgsExtraCheckedChangedListener listener) {
